...
namespace grammar {
    ...
    struct error_handler {
        template <typename Iterator, typename Exception, typename Context>
                    ...
                    , Exception const& x, Context const& context)
            {
                ...
                std::string message = "GAZ Error! Expecting: " + x.which() + " here:";
    ...
    struct lambda_class {};
    struct list_class: boost::spirit::x3::annotate_on_success, error_handler {};
    /* struct vector_class : boost::spirit::x3::annotate_on_success, error_handler {};; */
    struct vector_class {};
    struct map_entry_class : boost::spirit::x3::annotate_on_success, error_handler {};;
    struct map_class : boost::spirit::x3::annotate_on_success, error_handler {};;
    struct meta_class : boost::spirit::x3::annotate_on_success, error_handler {};;
    struct set_class : boost::spirit::x3::annotate_on_success, error_handler {};;
